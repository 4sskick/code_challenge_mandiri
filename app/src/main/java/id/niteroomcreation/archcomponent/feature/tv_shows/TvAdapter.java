 ...
 */
public class TvAdapter extends PagedListAdapter<TvShowEntity, TvAdapter.ViewHolder> {
    ...
    private static final DiffUtil.ItemCallback<TvShowEntity> DIFF_CALLBACK = new DiffUtil.ItemCallback<TvShowEntity>() {
        @Override
        public boolean areItemsTheSame(@NonNull @NotNull TvShowEntity oldItem, @NonNull @NotNull TvShowEntity newItem) {
            return oldItem.getId() == newItem.getId();
        }

        @Override
        public boolean areContentsTheSame(@NonNull @NotNull TvShowEntity oldItem, @NonNull @NotNull TvShowEntity newItem) {
            return oldItem.equals(newItem);
        }
    };
    private List<TvShowEntity> data;
    private final GenericItemListener<TvShowEntity, List<Pair<View, String>>> mListener;

    public TvAdapter(GenericItemListener<TvShowEntity, List<Pair<View, String>>> mListener) {
        super(DIFF_CALLBACK);
