 ...
 */
public class CTagPickerView extends LinearLayout {

    private static final String TAG = CTagPickerView.class.getSimpleName();
    ...
    public CTagPickerView(Context context) {
        super(context);
        this.mContext = context;
        init();
    }

    public CTagPickerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        this.mAttrs = attrs;
        init();
    ...
    public CTagPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        this.mItemMargin = (int) typeArray.getDimension(R.styleable.TagPickerView_tp_itemMargin, CommonUtils.dpToPx(this.getContext(), mItemMargin));
        this.textPaddingLeft = (int) typeArray.getDimension(R.styleable.TagPickerView_tp_textPaddingLeft, CommonUtils.dpToPx(this.getContext(), textPaddingLeft));
        this.textPaddingRight = (int) typeArray.getDimension(R.styleable.TagPickerView_tp_textPaddingRight, CommonUtils.dpToPx(this.getContext(), textPaddingRight));
        this.textPaddingTop = (int) typeArray.getDimension(R.styleable.TagPickerView_tp_textPaddingTop, CommonUtils.dpToPx(this.getContext(), textPaddingTop));
        this.texPaddingBottom = (int) typeArray.getDimension(R.styleable.TagPickerView_tp_textPaddingBottom, CommonUtils.dpToPx(this.getContext(), texPaddingBottom));
    ...
    public void drawItemView() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            itemWidth += CommonUtils.dpToPx(getContext(), 20) + textPaddingLeft + textPaddingRight;
